...
import { LayoutDashboard, Users, FileText, Settings, Image, LogOut, Menu as MenuIcon, Sun, Moon } from 'lucide-react';
            ...
            <aside className="admin-sidebar">
                ...
                <nav className="admin-nav">
                    <ul>
                        ...
                        <li><Link to="/admin/members"><Users size={20} /> 회원 관리</Link></li>
                        <li><Link to="/admin/boards"><FileText size={20} /> 게시판 관리</Link></li>
